...
class CrafterVerifiyEmailSignUp extends StatefulWidget {
  const CrafterVerifiyEmailSignUp({super.key});

  @override
  State<CrafterVerifiyEmailSignUp> createState() => _CrafterVerifiyEmailSignUpState();
}

class _CrafterVerifiyEmailSignUpState extends State<CrafterVerifiyEmailSignUp> {
              ...
              SizedBox(height: 24.h,),
               Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap:()=> context.pushReplacement(AppRouter.crafterverifiyemailsignuppath),
                    child: Text(
                      "Resend",
                      style: TextStyle(
                        color: ColorManager.olive2,
