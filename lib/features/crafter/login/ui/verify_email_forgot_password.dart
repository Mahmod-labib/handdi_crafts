...
class CrafterVerifiyEmailForgotPassword extends StatefulWidget {
  const CrafterVerifiyEmailForgotPassword({super.key});

  @override
  State<CrafterVerifiyEmailForgotPassword> createState() => _CrafterVerifiyEmailForgotPasswordState();
}

class _CrafterVerifiyEmailForgotPasswordState extends State<CrafterVerifiyEmailForgotPassword> {
              ...
              SizedBox(height: 24.h,),
               Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap:()=> context.pushReplacement(AppRouter.crafterverifiyemailforgotpasswordpath),
                    child: Text(
                      "Resend",
                      style: TextStyle(
                        color: ColorManager.olive2,
