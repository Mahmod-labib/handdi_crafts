              ...
              children: [
                InkWell(
                    ...
                    child: CustomContainer(
                        imgPath: "assets/images/Rectangle999.jpg",
                        text: "Craters")),
                SizedBox(
                  width: 20.w,
                ),
                InkWell(
                    ...
                    child: CustomContainer(
                        imgPath: "assets/images/Rectangle1000.jpg",
                        text: "Crafts")),
                SizedBox(
                  width: 20.w,
                ),
                InkWell(
                    onTap: () =>
                        context.pushReplacement(AppRouter.productsspath),
                    child: CustomContainer(
                        imgPath: "assets/images/Rectangle1001.jpg",
                        text: "Products")),
                SizedBox(
                  width: 20.w,
                ),
                InkWell(
                    ...
                    child: CustomContainer(
                        imgPath: "assets/images/courses.jpg", text: "Courses")),
                SizedBox(
                  width: 20.w,
                ),
                InkWell(
                    ...
                    child: CustomContainer(
                        imgPath: "assets/images/materials.jpg",
                        text: "Materials"))
              ],
            ),
          ),
