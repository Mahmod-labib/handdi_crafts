...
class CustomerIntroPage extends StatefulWidget {
  const CustomerIntroPage({super.key});

  @override
  State<CustomerIntroPage> createState() => _CustomerIntroPageState();
}

class _CustomerIntroPageState extends State<CustomerIntroPage> {
  @override
        ...
        children: [
          ...
          Container(
            ...
            child: MaterialButton(
              ...
              child:  Text("Login",
                  style: TextStyle(fontSize: FontSize.s16, color: ColorManager.white2,fontWeight: FontWeightManager.medium)),
            ),
          ),
