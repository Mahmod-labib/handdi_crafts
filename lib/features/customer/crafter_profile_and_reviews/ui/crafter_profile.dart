...
class CrafterProfile extends StatefulWidget {
  const CrafterProfile({super.key});

  @override
  State<CrafterProfile> createState() => _CrafterProfileState();
}

class _CrafterProfileState extends State<CrafterProfile> {
  @override
        ...
        child: Column(
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                CustomButton(text: "Following", fun: (){}, height: 46.h, width: 160.w, btncolor: ColorManager.olive2, textcolor: ColorManager.white2),
                SizedBox(width: 13.w,),
                CustomButton(text: "Review", fun: (){
                  context.pushReplacement(AppRouter.reviewpath);
                }, height: 46.h, width: 160.w, btncolor: ColorManager.white2, textcolor: ColorManager.olive2),
              ],
            ),
            SizedBox(height: 24.h,),
            Padding(
