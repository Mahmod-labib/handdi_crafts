...
class DeliveryVerifiyEmailSignUp extends StatefulWidget {
  const DeliveryVerifiyEmailSignUp({super.key});

  @override
  State<DeliveryVerifiyEmailSignUp> createState() => _DeliveryVerifiyEmailSignUpState();
}

class _DeliveryVerifiyEmailSignUpState extends State<DeliveryVerifiyEmailSignUp> {
              ...
              SizedBox(height: 24.h,),
               Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap:()=> context.pushReplacement(AppRouter.deliveryverifiyemailsignuppath),
                    child: Text(
                      "Resend",
                      style: TextStyle(
                        color: ColorManager.olive2,
